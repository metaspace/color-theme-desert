...
(defvar desert-mhl-bg "grey15") ;; mode-line, header-line
(defvar desert-modeline-bg "black")
(defvar desert-fixme-fg "orangered")
(defvar desert-fixme-bg "yellow2")
(defvar desert-hl-line "#330")
  ...
  (color-theme-install
   (append
    (list 'color-theme-desert
          ...
          `(mode-line ((t (:foreground "cornsilk4" :background ,desert-bg :box (:line-width 2 :color "cornsilk4")))))
	  ...
	  `(hl-line ((t (:inherit nil :background ,desert-hl-line))))
